...
// Add onMounted hook to fetch data when the component is mounted
onMounted(fetchIntrusionAlertsData);

// Add your logic to fix the intrusion alert
...
// Generate a unique title for each intrusion alert
function getAlertTitle(alert) {
  return `Intrusion Alert: ${alert.SSID} - ${alert.MACAddress}`;
}

// Check if the intrusion alert is fixed
